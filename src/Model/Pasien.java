...
public class Pasien extends Orang {
    ...
    public Pasien(String nama, String TTL, String alamat, String jenisKelamin, String noTelp, String NIK) {
        super(nama, TTL, alamat, jenisKelamin, noTelp, NIK);
    }


    public Pasien(String IdPasien, String Keluhan, String GolDar,String hasilTesLab, String nama, String TTL, String alamat, String jenisKelamin, String noTelp, String NIK) {
        super(nama, TTL, alamat, jenisKelamin, noTelp, NIK);
